...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private Button btnCancel; //确定、取消按钮
    ...
    private int xoffset_year, xoffset_month, xoffset_day, xoffset_hours, xoffset_mins,
            xoffset_seconds;
    ...
    public static class Builder {
        ...
        private String label_year, label_month, label_day, label_hours, label_mins,
                label_seconds;//单位
        private int xoffset_year, xoffset_month, xoffset_day, xoffset_hours, xoffset_mins,
                xoffset_seconds;//单位
        ...
        public Builder(Context context, OnTimeSelectListener listener, boolean isBlock) {
            this.context = context;
            this.timeSelectListener = listener;
        ...
        public Builder setLabel(String label_year, String label_month, String label_day, String
         ...
         * @return
         */
        public Builder setTextXOffset(int xoffset_year, int xoffset_month, int xoffset_day, int
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R
                    .string.pickerview_submit) : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources().getString(R
                    .string.pickerview_cancel) : Str_Cancel);
            ...
            customListener.customLayout(LayoutInflater.from(context).inflate(layoutRes,
                    contentContainer));
        }
        // 时间转轮 自定义控件
        LinearLayout timePickerView = (LinearLayout) findViewById(R.id.timepicker);

        timePickerView.setBackgroundColor(Color_Background_Wheel == 0 ? bgColor_default :
        ...
        setTime();
        wheelTime.setLabels(label_year, label_month, label_day, label_hours, label_mins,
                label_seconds);
        wheelTime.setTextXOffset(xoffset_year, xoffset_month, xoffset_day, xoffset_hours,
                xoffset_mins, xoffset_seconds);
        ...
        wheelTime.setOnItemChange(new OnItemChange() {
            @Override
    ...
    private void setTime() {
        ...
        wheelTime.setPicker(year, month, day, hours, minute, seconds, isBlock);
    }
    ...
    public void setLunarCalendar(boolean lunar) {
        try {
            ...
            wheelTime.setLabels(label_year, label_month, label_day, label_hours, label_mins,
                    label_seconds);
            wheelTime.setPicker(year, month, day, hours, minute, seconds, false);
        } catch (ParseException e) {
            e.printStackTrace();
        }
    }
    ...
    public interface OnTimeSelectListener {
        void onTimeSelect(Date date, View v) throws Exception;
    }
