 ...
 * 课程订单
 */
public class ClassOrderListActivity extends BaseActivity implements OnTabSelectListener, AdapterView.OnItemClickListener {
...
//        criteria = new Criteria();
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Bundle b = new Bundle();
        b.putInt("Leid",row.getInt("Leid"));
        openIntent(ClassOrderDetailActivity.class, R.string.class_detail,b);
    }
}
