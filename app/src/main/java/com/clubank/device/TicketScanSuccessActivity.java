...
public class TicketScanSuccessActivity extends BaseActivity implements TextWatcher {
    ...
    private void setDetails(MyRow row) {
        ...
        ImageView img = findViewById(R.id.succ_img);
        if (type.equals("ticket")) { //tyep：ticket 票务核销 lesson 签课核销
            show(R.id.verify_ll);
            img.setImageDrawable(getResources().getDrawable(R.mipmap.verify_succ));
            ...
            img.setImageDrawable(getResources().getDrawable(R.mipmap.class_succ));
    ...
    public void doWork(View view) {
        switch (view.getId()) {
            case R.id.finish:
                if (type.equals("ticket") || type.equals("paper")) {
